...
const DeviseAuth = () => {
  return (
    <BlogContainer
      ...
      description={
        'In this tutorial, we will learn to build a a school-like app in rails 7 and add authentication to it using the devise gem. In the next tutorial we will add several roles to the app'
      }
    >
