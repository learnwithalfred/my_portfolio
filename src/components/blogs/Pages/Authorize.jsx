      ...
      <div className="p-6 rounded-md shadow dark:shadow-gray-800">
        ...
        <div className="mt-6">
          ...
          <div className="my-8 py4">
            ...
            >
              Checkout the first lesson on rails authentication with devise gem
              here
            </Link>
          </div>
          ...
          <div>
            ...
            <p className="text-pink-900">
              ...
              throw an exception. Like the first example below
            </p>
            ...
            <p className="text-pink-900 py-8">
              ...
              need to authorize the controller action that require
